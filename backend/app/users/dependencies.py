...
from app.users.auth import get_user_from_token, decode_token, create_access_token
        ...
        try:
            ...
            if user_id:
                ...
                if user:
                    ...
                    response.set_cookie(f"{settings.PROJECT_NAME}_access_token", new_access_token, httponly=True)
        except Exception:
            user = None
