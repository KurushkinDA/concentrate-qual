...
async def get_concentrate_by_id_service(
    concentrate_id: int, session: AsyncSession
    ...
    Returns:
        ResponseWithData[SConcentrateRead]: Объект с сообщением и
          данными найденной записи.
    ...
    return ResponseWithData(
        message="Запись найдена", data=SConcentrateRead.model_validate(concentrate)
    )
